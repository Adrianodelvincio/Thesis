...
\item Data analysis and extraction of the transverse asymmetry for $^{12}C$.
...
\end{column}
\end{columns}
For (B0,B1,B2) we obtain $\chi^{2}_{ndof = 17}  = (35 \pm 6,35 \pm 6,30 \pm 6)$
\end{frame}
...
This demonstrates the validity of the new electronic setup with lower noise that improves the sensitivity for low rate Pb scattering and paves the road to the future MREX measurements.
...
% Neutron Skin and Neutron Star Radius
