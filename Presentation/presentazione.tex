...
\begin{figure}[hbtp]
\centering
\includegraphics[width = 0.75\textwidth]{figures/mami.png}
\end{figure}
...
\includegraphics[width = \textwidth]{figures/NINO.pdf}
\end{frame}
...
\begin{center}
\includegraphics[width = 0.75\textwidth]{figures/Monitors.pdf}
\end{center}
\end{frame}
