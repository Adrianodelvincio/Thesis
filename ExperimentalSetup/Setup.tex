...
\texttt{First description of the experiment, how we want to collect data, new picture of the kinematic of the experiment. Maybe here it's a good point to describe the structure of the event.} \\
...
\texttt{Briefly explain how the Mott polarimeter works, for measuring the polarization of the beam.} \\
