...
\caption{ Polarizability versus neutron star radius. The point are the prediction of different theoretical models. The upper bound with $90 \%$ credibility for the polarizability is shown in the figure.}
\end{figure}
