...
\section{Data with loss of polarity}

Here we report the result for the suspicious data without polarity. These data are analyzed separately from the other ones.
