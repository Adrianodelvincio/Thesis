...
\item Asymmetry for detector B, $A_{B} = -23 \pm 5$ ppm.
\end{itemize}
...
The sign of the asymmetry is given by the cross-product between the sign of the cross product between $\vec{k}$ incident electron and $\vec{k'}$ scattered electron. So it is negative for detector B, 
