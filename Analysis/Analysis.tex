...
\begin{figure}[hbtp]
\centering
\subfloat[][\emph{Threshold dependence against attenuation. The values are obtained for a fixed shape of the input signal and a fixed value of \textit{Thr} = 750.} \label{fig:ThrvsAtt}]{
