...
With a linear fit we can estimate the scale and the offset to convert from I21 voltage values to physical values of the current. We do the same for each pmt:

\begin{figure}[hbtp]
\centering
\includegraphics[width = 0.5\textwidth]{Analysis/Autocalib/fitB.pdf}
\caption{Counts vs. current, the error are multiplied by a factor of $20$.}
\end{figure}
