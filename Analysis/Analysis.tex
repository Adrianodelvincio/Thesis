...
We have computed the time needed to achieve this accuracy for both the two detectors, given in total hours of beam-time. This values are not casual: as we will see in the next part of this chapter, we managed to obtain this accuracy for the same measurement on carbon  
