...
\begin{figure}[hbtp]
\centering
\includegraphics[width = 0.7\textwidth]{Analysis/Asym_vs_monitor.png}
...
In the following plots we decided to apply some cuts to the data, selecting only the events where the values of all the monitor are less then 3 standard deviation far from the mean: 

\begin{align*}
(x_{monitor} - \overline{x}_{monitor} \leq 3 \sigma_{X})
\end{align*}

\begin{figure}[hbtp]
\centering
\includegraphics[width = 0.45\textwidth]{Analysis/clustering_X.png}
