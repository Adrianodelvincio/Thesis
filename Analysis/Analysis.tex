...
{\includegraphics[width = 0.75\textwidth]{Analysis/Fit_attenuation.pdf}}
\end{figure}
...
The figures are referred to the data acquired for the first autocalibration. It's interesting to calculate, from the result of the fit, the factor that appears in \ref{eq:Systematic}: \bigskip
